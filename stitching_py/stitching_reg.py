# stitching - command line tool for whole-body image stitching and registering the overlap.
# Copyright 2022 Robert Graf
...
def compute_overlap(image1, image2, verbose=False) -> None:
    if image1 == None:
        return None
    ...
    if len(files) > 1:
        ...
        for img1, img2 in zip(images[:-1], images[1:]):
            ...
            if out is not None:
                ...
                # register images
                cur_transform = affine_registration_transform(inter1, inter2)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-me", "--mean_shift", default=False, action=argparse.BooleanOptionalAction, help="shift means around to match them"
    )
